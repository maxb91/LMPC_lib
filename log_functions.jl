...
function pos_info_callback(msg::pos_info,pos_info_log::Measurements)
    ...
    pos_info_log.z[pos_info_log.i,:]    = [msg.s;msg.ey;msg.epsi;msg.v;msg.s_start;msg.x;msg.y;msg.v_x;msg.v_y;msg.psi;msg.psiDot;msg.x_raw;msg.y_raw;msg.psi_raw;msg.v_raw;msg.psi_drift;msg.a_x;msg.a_y]
    pos_info_log.i += 1
    nothing
end
