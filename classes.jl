...
type OldTrajectory      # information about previous trajectories
    ...
    OldTrajectory(oldTraj=Float64[],oldInput=Float64[],oldTimes=Float64[],oldCost=Float64[],count=Int32[],prebuf=50,postbuf=50,idx_start=Int32[],idx_end=Int32[]) = new(oldTraj,oldInput,oldTimes,oldCost,count,prebuf,postbuf,idx_start,idx_end)
end
